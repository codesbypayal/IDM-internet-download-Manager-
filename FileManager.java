...
public class FileManager {
    ...
    public static void writeFiles(ArrayList<MyFile> files) {
        try (ObjectOutputStream oosAll = new ObjectOutputStream(new FileOutputStream("C:\\Users\\payal\\OneDrive\\Documents\\JAVA\\project\\data", false));
             ObjectOutputStream oosQueue = new ObjectOutputStream(new FileOutputStream("C:\\Users\\payal\\OneDrive\\Documents\\JAVA\\project\\data", false))) {
    ...
    /**
     * A method to read whole files of program from data folder.
     */
    ...
    public static void readLanguageFile() {
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("C:\\Users\\payal\\OneDrive\\Documents\\JAVA\\project"))) {
            try {
